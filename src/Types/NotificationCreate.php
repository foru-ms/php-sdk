...
class NotificationCreate extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<NotificationCreateStatus> $status Initial notification status
     */
    #[JsonProperty('status')]
     ...
     *   status?: ?value-of<NotificationCreateStatus>,
