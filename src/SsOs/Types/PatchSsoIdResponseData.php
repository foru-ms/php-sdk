...
class PatchSsoIdResponseData extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<PatchSsoIdResponseDataProvider> $provider SSO provider type
     */
     ...
     * @param array{
     *   id: string,
     *   provider: value-of<PatchSsoIdResponseDataProvider>,
     *   domain: string,
     *   active: bool,
     *   createdAt: string,
     *   updatedAt: string,
