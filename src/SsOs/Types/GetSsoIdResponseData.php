...
class GetSsoIdResponseData extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<GetSsoIdResponseDataProvider> $provider SSO provider type
     */
     ...
     * @param array{
     *   id: string,
     *   provider: value-of<GetSsoIdResponseDataProvider>,
     *   domain: string,
     *   active: bool,
     *   createdAt: string,
     *   updatedAt: string,
