...
class GetSsoResponseDataItem extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<GetSsoResponseDataItemProvider> $provider SSO provider type
     */
     ...
     * @param array{
     *   id: string,
     *   provider: value-of<GetSsoResponseDataItemProvider>,
     *   domain: string,
     *   active: bool,
     *   createdAt: string,
     *   updatedAt: string,
