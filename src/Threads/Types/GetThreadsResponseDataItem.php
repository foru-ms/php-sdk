...
class GetThreadsResponseDataItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?GetThreadsResponseDataItemPoll $poll Poll data
     */
    #[JsonProperty('poll')]
    public ?GetThreadsResponseDataItemPoll $poll;
     ...
     *   userId?: ?string,
     *   tags?: ?array<string>,
     *   poll?: ?GetThreadsResponseDataItemPoll,
     *   slug?: ?string,
     *   locked?: ?bool,
     *   pinned?: ?bool,
     *   lastPostAt?: ?string,
