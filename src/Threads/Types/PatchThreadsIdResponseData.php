...
class PatchThreadsIdResponseData extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?PatchThreadsIdResponseDataPoll $poll Poll data
     */
    #[JsonProperty('poll')]
    public ?PatchThreadsIdResponseDataPoll $poll;
     ...
     *   userId?: ?string,
     *   tags?: ?array<string>,
     *   poll?: ?PatchThreadsIdResponseDataPoll,
     *   slug?: ?string,
     *   locked?: ?bool,
     *   pinned?: ?bool,
     *   lastPostAt?: ?string,
