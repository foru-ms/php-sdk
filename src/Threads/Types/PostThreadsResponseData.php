...
class PostThreadsResponseData extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?PostThreadsResponseDataPoll $poll Poll data
     */
    #[JsonProperty('poll')]
    public ?PostThreadsResponseDataPoll $poll;
     ...
     *   userId?: ?string,
     *   tags?: ?array<string>,
     *   poll?: ?PostThreadsResponseDataPoll,
     *   slug?: ?string,
     *   locked?: ?bool,
     *   pinned?: ?bool,
     *   lastPostAt?: ?string,
