...
class PatchRolesIdResponseData extends JsonSerializableType
{
    /**
    ...
    /**
     * @var string $createdAt Role creation timestamp
     */
    #[JsonProperty('createdAt')]
    public string $createdAt;

    /**
     * @var string $updatedAt Role last update timestamp
     */
