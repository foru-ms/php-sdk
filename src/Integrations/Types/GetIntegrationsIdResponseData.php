...
class GetIntegrationsIdResponseData extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<GetIntegrationsIdResponseDataType> $type Integration type
     */
    #[JsonProperty('type')]
    public string $type;
     ...
     * @param array{
     *   id: string,
     *   type: value-of<GetIntegrationsIdResponseDataType>,
     *   name: string,
     *   active: bool,
     *   createdAt: string,
     *   updatedAt: string,
