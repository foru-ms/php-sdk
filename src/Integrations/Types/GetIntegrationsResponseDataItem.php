...
class GetIntegrationsResponseDataItem extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<GetIntegrationsResponseDataItemType> $type Integration type
     */
    #[JsonProperty('type')]
    public string $type;
     ...
     * @param array{
     *   id: string,
     *   type: value-of<GetIntegrationsResponseDataItemType>,
     *   name: string,
     *   active: bool,
     *   createdAt: string,
     *   updatedAt: string,
