...
class PatchIntegrationsIdResponseData extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<PatchIntegrationsIdResponseDataType> $type Integration type
     */
    #[JsonProperty('type')]
    public string $type;
     ...
     * @param array{
     *   id: string,
     *   type: value-of<PatchIntegrationsIdResponseDataType>,
     *   name: string,
     *   active: bool,
     *   createdAt: string,
     *   updatedAt: string,
