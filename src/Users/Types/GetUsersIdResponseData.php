...
class GetUsersIdResponseData extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var ?array<GetUsersIdResponseDataRolesItem> $roles User roles
     */
    #[JsonProperty('roles'), ArrayType([GetUsersIdResponseDataRolesItem::class])]
    public ?array $roles;
     ...
     *   isOnline?: ?bool,
     *   lastSeenAt?: ?string,
     *   roles?: ?array<GetUsersIdResponseDataRolesItem>,
