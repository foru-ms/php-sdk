...
class PatchUsersIdResponseData extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var ?array<PatchUsersIdResponseDataRolesItem> $roles User roles
     */
    #[JsonProperty('roles'), ArrayType([PatchUsersIdResponseDataRolesItem::class])]
    public ?array $roles;
     ...
     *   isOnline?: ?bool,
     *   lastSeenAt?: ?string,
     *   roles?: ?array<PatchUsersIdResponseDataRolesItem>,
